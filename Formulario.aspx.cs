...
namespace WebApplication1
{
    public partial class Projeto_Painel : System.Web.UI.Page
    {
        ...
        protected void BtnEnv_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMensagemSucesso.Text = "Dados enviados com sucesso!";
                lblMensagemSucesso.Visible = true;

                //Aqui eu chamo um Alert na tela informando que deu tudo certo e os dados foram enviados usando uma função em Javascript
                ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('" + lblMensagemSucesso.Text + "');", true);
            }
        }
