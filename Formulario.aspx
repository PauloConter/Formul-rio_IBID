        ...
        <div class="container">
            <asp:Panel ID="PnlPrincipal" runat="server" CssClass="panelPrinc-style">
                <asp:Panel ID="PnlInfPessoais" runat="server" Height="332px"  CssClass="panel-style">
                    <h1 class="auto-style1" aria-atomic="True" aria-autocomplete="both"style="background-color: #009933; font-family: Arial; color: white;">Dados pessoais </h1>
                <table style="height: 215px; width: 326px">
                    ...
                    <asp:Button ID="btnSubmit" runat="server" Text="Próximo" OnClick="btnSubmit_Click" style="background-color: #009933" CssClass="buton" BackColor="#00CC00" BorderColor="#00CC00" ForeColor="White"/>

                </asp:Panel>
                <asp:Panel ID="PnlEndPessoal" runat="server" Height="338px" style="margin-top: 63px" Visible="false" CssClass="panel-style">
                    <h1><span class="auto-style2"style="background-color: #009933; font-family: Arial; color: white;">Detalhes do Endereço</span></h1>
                    <table style="height: 215px; width: 326px">
                        <tr>
                            <td>Endereço:</td>
                            <td>
                    ...
                    <br />
                <div class="butons">
                    <asp:Button ID="BtnVoltar" runat="server" style="background-color: #009933" Text="Voltar" OnClick="BtnVoltar_Click" CssClass="butonBack" BackColor="#00CC00" BorderColor="#009933" ForeColor="White"/>&nbsp; 
                    <asp:Button ID="BtnProxEnd" runat="server" style="background-color: #009933" Text="Próximo" OnClick="BtnProxEnd_Click" CssClass="buton" ForeColor="White"/>
                </div>

                </asp:Panel>    
                <asp:Panel ID="PnlLogin" runat="server" style="margin-top: 26px" Visible="false" CssClass="panel-style">
                    <h1><span class="auto-style3"><strong style="background-color: #009933; font-family: Arial; color: white;" aria-atomic="True">Área de Login</strong></span></h1>
                    ...
                    <div class="butons">
                    <div class="butons">
                        <asp:Button ID="BtnVoltar2" runat="server" style="background-color: #009933; margin-right: 10px;" Text="Voltar" OnClick="BtnVoltar2_Click" CssClass="butonBack" ForeColor="White" />
                        ...
                        <asp:Label ID="lblMensagemSucesso" runat="server" Visible="false" Text="Dados enviados com sucesso!" ForeColor="Green"></asp:Label>
                    </div>
                  </asp:Panel>
               </asp:Panel>
        </div>
